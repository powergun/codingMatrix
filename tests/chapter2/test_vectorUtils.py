...
from ctm.chapter2 import vectorUtils
...
class TestCrossProduct(unittest.TestCase):
    ...
    def _sequenceAlmostEqual(self, s1, s2, places=7):
        ...
        for idx in xrange(len(s1)):
            self.assertAlmostEqual(s1[idx], s2[idx], places=places, msg='idx {}, v1 {} != v2 {}'.format(
                idx, s1[idx], s2[idx]))

    def test_expectResultPerpendicular(self):
        actual = vectorUtils.cross_product_f3([1.5, 0, -13], [-31.2, 0.4, 1.31413])
